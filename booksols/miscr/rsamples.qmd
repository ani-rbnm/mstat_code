...
<<<<<<< HEAD
### Environment Scope
* variables have either *local* or *global* levels
* code only has *read-only access to global* variables

### Some Tricks

* Sorting a data frame - using `order()` to get indices of sorting. This is similar to which for `sort()`
...
>>>>>>> 2a147e5880729885d1d76ab4c0c06053bd9af366
